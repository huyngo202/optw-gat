...
\newpage
\section*{\makebox[\textwidth][c]{DANH MỤC TỪ VIẾT TẮT}}
\begin{center}
\begin{tabular}{p{2cm} p{6cm} p{6cm}}
\textbf{Từ} & \textbf{Tiếng Anh} & \textbf{Giải thích} \\

OPTW & Orienteering Problem with Time Windows & Bài toán định hướng có khung thời gian \\
TTDP & Tourist Trip Design Problem & Bài toán thiết kế lịch trình du lịch \\
...
GAT  & Graph Attention Network & Mạng chú ý đồ thị \\
LSTM & Long Short-Term Memory & Bộ nhớ ngắn–dài hạn \\
RNN  & Recurrent Neural Network & Mạng nơ-ron hồi quy \\

ILS  & Iterated Local Search & Tìm kiếm cục bộ lặp \\
BS   & Beam Search & Tìm kiếm chùm \\
\end{tabular}
\end{center}
